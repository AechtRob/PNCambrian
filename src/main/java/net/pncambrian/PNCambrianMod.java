...
import net.lepidodendron.EntityRegistries;
...
@Mod(modid = PNCambrianMod.MODID, name = PNCambrianMod.NAME, version = PNCambrianMod.VERSION, dependencies = "required-after:lepidodendron@[60.0,)")
public class PNCambrianMod {
    ...
    @Mod.Instance(MODID)
    public static PNCambrianMod instance;
    public ElementsPNCambrianMod elements = new ElementsPNCambrianMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsPNCambrianMod.GuiHandler());
