...
public class BiomeCambrianEstuary extends ElementsPNCambrianMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCambrian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Cambrian Lagoonal Pools").setRainfall(0.5F).setBaseHeight(1.125F).setHeightVariation(0.00F).setTemperature(0.95F).setRainfall(0.9F));
																										/// -0.175F + 0.4
