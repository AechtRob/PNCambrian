...
public class BiomeCambrianEstuary extends ElementsPNCambrianMod.ModElement {
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new BiomeProperties("Cambrian Estuary Lagoons").setRainfall(0.5F).setBaseHeight(-0.75F).setHeightVariation(0.00F).setTemperature(0.95F).setRainfall(0.9F));
