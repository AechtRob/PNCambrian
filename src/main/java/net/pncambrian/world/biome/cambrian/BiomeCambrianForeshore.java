...
public class BiomeCambrianForeshore extends ElementsPNCambrianMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cambrian_foreshore")
	public static final BiomeGenCustom biome = null;
	public BiomeCambrianForeshore(ElementsPNCambrianMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCambrian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Cambrian Silty Shore").setRainfall(0.5F).setBaseHeight(0.825F).setHeightVariation(0.00F).setTemperature(0.95F).setRainfall(0.9F));

			setRegistryName("lepidodendron:cambrian_foreshore");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 12; ++ii) {
					...
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					if (worldIn.getBiome(pos.add(j, 0, k)) == this) {
						SPONGE_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), 1, 30, 0, 255, BlockBlueSponge.block);
					}
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 12; ++ii) {
					...
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					if (worldIn.getBiome(pos.add(j, 0, k)) == this) {
						SPONGE_SIDEWAYS_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), 1, 30, 0, 255, BlockBlueSponge.block);
					}
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 12; ++ii) {
					...
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					if (worldIn.getBiome(pos.add(j, 0, k)) == this) {
						SPONGE_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), 1, 30, 0, 255, BlockPinkSponge.block);
					}
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 12; ++ii) {
					...
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					if (worldIn.getBiome(pos.add(j, 0, k)) == this) {
						SPONGE_SIDEWAYS_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), 1, 30, 0, 255, BlockPinkSponge.block);
					}
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 12; ++ii) {
					...
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					if (worldIn.getBiome(pos.add(j, 0, k)) == this) {
						SPONGE_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), 1, 30, 0, 255, BlockWhiteSponge.block);
					}
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 12; ++ii) {
					...
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					if (worldIn.getBiome(pos.add(j, 0, k)) == this) {
						SPONGE_SIDEWAYS_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), 1, 30, 0, 255, BlockWhiteSponge.block);
					}
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 20; ++ii)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					STATIC_GENERATOR.generate(BlockGirvanella.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 100, 0, 255);
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 60; ++ii)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					STATIC_GENERATOR.generate(BlockHalichondrites.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 100, 0, 255);
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int ii = 0; ii < 1; ++ii)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getSeaLevel() + 25);
					STATIC_GENERATOR.generate(BlockTawuia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 15, 0, 255);
				}
		...
		public EnumBiomeTypeCambrian getBiomeType() {
			return EnumBiomeTypeCambrian.Emu;
		}
