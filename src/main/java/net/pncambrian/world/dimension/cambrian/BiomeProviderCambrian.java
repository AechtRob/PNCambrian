...
public class BiomeProviderCambrian extends BiomeProvider {
    ...
    protected BiomeProviderCambrian() {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = Lists.newArrayList(allowedBiomes);
    }

    public BiomeProviderCambrian(long seed, WorldType worldType, String options) {
        this();
        GenLayer[] agenlayer = GenLayerCambrian.initializeAllBiomeGenerators(seed, worldType, options);
        agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public BiomeProviderCambrian(long seed, WorldInfo info) {
