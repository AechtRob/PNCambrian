...
public class ChunkProviderCambrian implements IChunkGenerator {
    public static final IBlockState STONE = Blocks.STONE.getStateFromMeta(0);
    public static final IBlockState STONE2 = Blocks.GRAVEL.getStateFromMeta(0);
    ...
    public ChunkProviderCambrian(World worldIn, long seed) {
